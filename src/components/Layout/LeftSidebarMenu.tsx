              ...
              >
                ...
                <AccordionDetails className="mat-details">
                  <ul className="sidebar-sub-menu">
                    ...
                    <li className="sidemenu-item">
                      <Link
                        href="/cms/course-landing/"
                        className={`sidemenu-link ${pathname === "/cms/course-landing/"
                          }`}
                      >
                        Course Landing Page
                      </Link>
                    ...
                    <li className="sidemenu-item">
                      <Link
                        href="/cms/event-landing/"
                        className={`sidemenu-link ${pathname === "/cms/event-landing/"
                          }`}
                      >
                        Event Landing Page
                      </Link>
                    ...
                    <li className="sidemenu-item">
                      <Link
                        href="/cms/hero-section/"
                        className={`sidemenu-link ${pathname === "/cms/hero-section/"
                          }`}
                      >
                        Hero Section
                      </Link>
